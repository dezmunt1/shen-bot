...
bot.help(ctx => {
  ...
  4. <code>/postme</code> - рандомный репост из доступного списка групп и каналов, можешь добавить свой ресурс как источник, тем самым делясь контентом с другими.\n
