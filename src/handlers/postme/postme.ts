...
//     if (actionsType === 'receivingСontent') {
//       await ctx.reply('\u2060', {
//         reply_markup: {
//           inline_keyboard: [
...
//     if (
//       (actionsType === 'content' || actionsType === 'contentMore') &&
//       channPostTrue !== 'options'
//     ) {
//       getPost(ctx, params);
//     }
...
// export const selectSource = async (ctx, options) => {
//   try {
//     const { chatId, messageId } = ctx.session.postme;
...
// export const selectedSource = async (ctx, listeningChatId) => {
//   try {
...
// export const setSource = async (ctx, options) => {
//   try {
...
// export const typeSource = async (ctx, msgType) => {
//   try {
//     const { chatId, messageId } = ctx.session.postme;
//     const optionsForDb = {
//       chatId: ctx.chat.id,
...
// export const delSource = async (ctx) => {
//   try {
//     const { chatId, messageId } = ctx.session.postme;
//     const optionsForDb = {
//       chatId,
...
// export const getPost = async (ctx, params) => {
//   try {
